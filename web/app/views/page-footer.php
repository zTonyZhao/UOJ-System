...
?>
			...
			<div class="uoj-footer">
				...
				<a href="<?= HTML::url('/eula') ?>" target="_blank"><?= UOJLocale::get('eula') ?></a>  
				<?php endif ?>
				<?php if (UOJConfig::$data['switch']['privacy-policy']): ?>
				<a href="<?= HTML::url('/privacy-policy') ?>" target="_blank"><?= UOJLocale::get('privacy policy') ?> </a>
				<?php endif ?>
			</div>
			<?php endif ?>
		</div>
